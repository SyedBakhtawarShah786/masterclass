...
class  Tophive_Customizer {
	...
	function get_typo_fields() {
		$typo_fields = array(
			array(
				'name'    => 'font',
				'type'    => 'select',
				'label'   => esc_html__( 'Font Family', 'masterclass' ),
				'choices' => array(),
			),
			array(
				'name'    => 'font_weight',
				'type'    => 'select',
				'label'   => esc_html__( 'Font Weight', 'masterclass' ),
				'choices' => array(),
			),
			array(
				'name'  => 'languages',
				'type'  => 'checkboxes',
				'label' => esc_html__( 'Font Languages', 'masterclass' ),
			),
			array(
				'name'            => 'font_size',
				'type'            => 'slider',
				'label'           => esc_html__( 'Font Size', 'masterclass' ),
			...
			array(
				'name'            => 'line_height',
				'type'            => 'slider',
				'label'           => esc_html__( 'Line Height', 'masterclass' ),
				'device_settings' => true,
				'min'             => 9,
				'max'             => 80,
				'step'            => 1,
			...
			array(
				'name'  => 'letter_spacing',
				'type'  => 'slider',
				'label' => esc_html__( 'Letter Spacing', 'masterclass' ),
				'min'   => - 10,
				'max'   => 10,
				'step'  => 0.1,
			),
			array(
				'name'    => 'style',
				'type'    => 'select',
				'label'   => esc_html__( 'Font Style', 'masterclass' ),
				'choices' => array(
					''        => esc_html__( 'Default', 'masterclass' ),
					'normal'  => esc_html__( 'Normal', 'masterclass' ),
					'italic'  => esc_html__( 'Italic', 'masterclass' ),
					'oblique' => esc_html__( 'Oblique', 'masterclass' ),
				),
			),
			array(
				'name'    => 'text_decoration',
				'type'    => 'select',
				'label'   => esc_html__( 'Text Decoration', 'masterclass' ),
				'choices' => array(
					''             => esc_html__( 'Default', 'masterclass' ),
					'underline'    => esc_html__( 'Underline', 'masterclass' ),
					'overline'     => esc_html__( 'Overline', 'masterclass' ),
					'line-through' => esc_html__( 'Line through', 'masterclass' ),
					'none'         => esc_html__( 'None', 'masterclass' ),
				),
			),
			array(
				'name'    => 'text_transform',
				'type'    => 'select',
				'label'   => esc_html__( 'Text Transform', 'masterclass' ),
				'choices' => array(
					''           => esc_html__( 'Default', 'masterclass' ),
					'uppercase'  => esc_html__( 'Uppercase', 'masterclass' ),
					'lowercase'  => esc_html__( 'Lowercase', 'masterclass' ),
					'capitalize' => esc_html__( 'Capitalize', 'masterclass' ),
					'none'       => esc_html__( 'None', 'masterclass' ),
				),
			),
		);
	...
	function get_styling_config() {
		$fields = array(
			'tabs'          => array(
				'normal' => esc_html__( 'Normal', 'masterclass' ),  // null or false to disable.
				'hover'  => esc_html__( 'Hover', 'masterclass' ), // null or false to disable.
			),
			'normal_fields' => array(
				array(
					'name'       => 'text_color',
					'type'       => 'color',
					'label'      => esc_html__( 'Color', 'masterclass' ),
					'css_format' => 'color: {{value}}; text-decoration-color: {{value}};',
				),
				array(
					'name'       => 'link_color',
					'type'       => 'color',
					'label'      => esc_html__( 'Link Color', 'masterclass' ),
					'css_format' => 'color: {{value}}; text-decoration-color: {{value}};',
				),
				...
				array(
					...
					'label'           => esc_html__( 'Padding', 'masterclass' ),
				),

				array(
					'name'  => 'bg_heading',
					'type'  => 'heading',
					'label' => esc_html__( 'Background', 'masterclass' ),
				),

				array(
					'name'       => 'bg_color',
					'type'       => 'color',
					'label'      => esc_html__( 'Background Color', 'masterclass' ),
				...
				array(
					'name'  => 'border_heading',
					'type'  => 'heading',
					'label' => esc_html__( 'Border', 'masterclass' ),
				),
				...
				array(
					...
					'type'       => 'select',
					'class'      => 'clear',
					'label'      => esc_html__( 'Border Style', 'masterclass' ),
					'default'    => '',
					'choices'    => array(
						''       => esc_html__( 'Default', 'masterclass' ),
						'none'   => esc_html__( 'None', 'masterclass' ),
						'solid'  => esc_html__( 'Solid', 'masterclass' ),
						'dotted' => esc_html__( 'Dotted', 'masterclass' ),
						'dashed' => esc_html__( 'Dashed', 'masterclass' ),
						'double' => esc_html__( 'Double', 'masterclass' ),
						'ridge'  => esc_html__( 'Ridge', 'masterclass' ),
						'inset'  => esc_html__( 'Inset', 'masterclass' ),
						'outset' => esc_html__( 'Outset', 'masterclass' ),
					),
				...
				array(
					'name'       => 'border_width',
					'type'       => 'css_ruler',
					'label'      => esc_html__( 'Border Width', 'masterclass' ),
					'required'   => array(
				...
				array(
					'name'       => 'border_color',
					'type'       => 'color',
					'label'      => esc_html__( 'Border Color', 'masterclass' ),
					'required'   => array(
						array( 'border_style', '!=', 'none' ),
						array( 'border_style', '!=', '' ),
					),
	...
	function register( $wp_customize ) {
		...
		$wp_customize->get_section( 'title_tagline' )->title        = esc_html__( 'Logo & Site Identity', 'masterclass' );
