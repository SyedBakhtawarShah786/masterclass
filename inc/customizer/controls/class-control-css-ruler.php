...
class Tophive_Customizer_Control_Css_Ruler extends Tophive_Customizer_Control_Base {
	static function field_template() {
		...
		var defaultpl = <?php echo json_encode( esc_html__( 'Auto', 'masterclass' ) ); // phpcs:ignore ?>;
		...
		<div class="tophive-field-settings-inner">
			<div class="tophive--css-unit" title="<?php esc_attr_e( 'Chose an unit', 'masterclass' ); ?>">
				<label class="<# if ( field.value.unit == 'px' || ! field.value.unit ){ #> tophive--label-active <# } #>">
					<?php _e( 'px', 'masterclass' ); ?>
			...
			<div class="tophive--css-ruler tophive--gr-inputs">
				<span>
					...
					<span class="tophive--small-label"><?php _e( 'Top', 'masterclass' ); ?></span>
				</span>
				<span>
					...
					<span class="tophive--small-label"><?php _e( 'Right', 'masterclass' ); ?></span>
				</span>
				<span>
					...
					<span class="tophive--small-label"><?php _e( 'Bottom', 'masterclass' ); ?></span>
				</span>
				<span>
					...
					<span class="tophive--small-label"><?php _e( 'Left', 'masterclass' ); ?></span>
				</span>
				<label title="<?php esc_attr_e( 'Toggle values together', 'masterclass' ); ?>" class="tophive--css-ruler-link <# if ( field.value.link == 1 ){ #> tophive--label-active <# } #>">
