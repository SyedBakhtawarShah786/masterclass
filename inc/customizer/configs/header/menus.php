...
class Tophive_Builder_Item_Primary_Menu {
	...
	function __construct() {
		...
		$this->label          = esc_html__( 'Primary Menu', 'masterclass' );
	...
	function customize() {
		...
		$config  = array(
			array(
				...
				'theme_supports' => '',
				'title'          => $this->label,
				'description'    => sprintf( esc_html__( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'masterclass' ), $this->label ),
			),
			...
			array(
				...
				'render_callback' => $fn,
				'title'           => esc_html__( 'Menu Preset', 'masterclass' ),
				'default'         => 'style-plain',
			...
			array(
				...
				'selector'   => 'format',
				'max'        => 20,
				'title'      => esc_html__( 'Border Height', 'masterclass' ),
			...
			array(
				...
				'min'        => - 50,
				'max'        => 50,
				'title'      => esc_html__( 'Border Position', 'masterclass' ),
			...
			array(
				...
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
				'checkbox_label' => esc_html__( 'Hide menu dropdown arrow', 'masterclass' ),
				'css_format'     => 'html_class',
			),
			...
			array(
				...
				'selector'        => 'format',
				'max'             => 20,
				'title'           => esc_html__( 'Arrow icon size', 'masterclass' ),
			...
			array(
				...
				'type'    => 'heading',
				'section' => $section,
				'title'   => esc_html__( 'Top Menu', 'masterclass' ),
			),
			...
			array(
				...
				'type'        => 'styling',
				'section'     => $section,
				'title'       => esc_html__( 'Top Menu Items Styling', 'masterclass' ),
				'description' => esc_html__( 'Styling for top level menu items', 'masterclass' ),
				'selector'    => array(
				...
				'fields'      => array(
					'tabs'          => array(
						...
						'hover'  => esc_html__( 'Hover/Active', 'masterclass' ),
					),
					'normal_fields' => array(
						'link_color'    => false,
						'bg_cover'      => false,
			...
			array(
				...
				'type'        => 'typography',
				'section'     => $section,
				'title'       => esc_html__( 'Top Menu Items Typography', 'masterclass' ),
				'description' => esc_html__( 'Typography for menu', 'masterclass' ),
			...
			array(
				...
				'type'        => 'styling',
				'section'     => $section,
				'title'       => esc_html__( 'Drop Menu Items Styling', 'masterclass' ),
				'description' => esc_html__( 'Styling for dropdown menu items', 'masterclass' ),
				'selector'    => array(
			...
			array(
				...
				'type'        => 'typography',
				'section'     => $section,
				'title'       => esc_html__( 'Dropdown Menu Items Typography', 'masterclass' ),
				'description' => esc_html__( 'Typography for dropdown menu', 'masterclass' ),
			...
			array(
				...
				'min'        => 200,
				'max'        => 500,
				'title'      => esc_html__( 'Drop Down Width', 'masterclass' ),
	 ...
	 */
	function render() {
		$style = sanitize_text_field( top_hive()->get_setting( $this->prefix . '_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( top_hive()->get_setting( $this->prefix . '__hide-arrow' ) );
		if ( $hide_arrow ) {
...
class Tophive_Builder_Item_Secondary_Menu extends Tophive_Builder_Item_Primary_Menu{
	...
	function __construct() {
		...
		$this->label          = esc_html__( 'Secondary Menu', 'masterclass' );
